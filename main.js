export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    [
      'kpop_stats_csv.csv',
      new URL(
        './files/95ecdea210eb8f3612976d3bdbcd36af01f758d757a7e26c916c069f97c55ab5b5793c850ba9f7be6cdf2a5c02f5b9a57051e90b88c2f627af8906e5dcf72dd9',
        import.meta.url
      ),
    ],
  ]);
...
A visualization of YouTube MV views by the top 15 k-pop artists from 2011 - 2020. With the rise of globalization and the near ubiquity of social media and media streaming sites like YouTube comes the rise of k-pop and artists like Psy and BTS. Did your favorites make the cut?

Data source: http://kpop.daisuki.com.br/kpop_statistics.html`;
  });
  main
    .variable(observer('data'))
    .define('data', ['FileAttachment'], function (FileAttachment) {
      return FileAttachment('kpop_stats_csv.csv').csv({ typed: true });
    });
  main
