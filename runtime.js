...
function w(n, i, o, a) {
  ...
  n instanceof Map
    ...
    ? n instanceof n.constructor
      ...
      : ((s = 'Set()'), (l = S))
    : d
    ? ((s = `${n.constructor.name}(${n.length})`), (l = x))
    : (c = m(n))
    ? ((s = `Immutable.${c.name}${'Record' === c.name ? '' : `(${n.size})`}`),
      (d = c.arrayish),
      (l = c.arrayish ? C : c.setish ? E : P))
    : a
    ? ((s = f(n)), (l = N))
    : ((s = f(n)), (l = S));
...
function* U(e) {
  ...
  for (const r = e.size; n < r; ++n)
    n > t + 1 && (yield I(n - t - 1)), yield oe(e.get(n), !0), (t = n);
  n > t + 1 && (yield I(n - t - 1));
}
function* R(e) {
  let t = -1,
  ...
  for (const n = e.length; r < n; ++r)
    r in e &&
      (r > t + 1 && (yield I(r - t - 1)), yield oe(p(e, r), !0), (t = r));
  r > t + 1 && (yield I(r - t - 1));
  for (const t in e)
...
async function Me(e, t, { array: n = !1, typed: r = !1 } = {}) {
  const [i, o] = await Promise.all([
    e.text(),
    ge('d3-dsv@2.0.0/dist/d3-dsv.min.js'),
  ]);
  return ('\t' === t
    ? n
      ? o.tsvParseRows
...
var Oe = {
  ...
  element: function (e, t) {
    ...
    var o = Le.hasOwnProperty(r)
      ? document.createElementNS(Le[r], e)
              ...
              e(Be + 'highlight.min.js').then(function (t) {
                i.forEach(function (n) {
                  ...
                  t.getLanguage(n.className)
                    ? r()
                    : e(Be + 'async-languages/index.js')
                        .then((r) => {
                          if (r.has(n.className))
                            return e(
                              Be + 'async-languages/' + r.get(n.className)
                            ).then((e) => {
...
var rt = Object.assign(
  function (e) {
    const t = Xe(e);
    Object.defineProperties(this, {
      DOM: { value: Oe, writable: !0, enumerable: !0 },
      FileAttachment: { value: je(qe), writable: !0, enumerable: !0 },
      Files: { value: Te, writable: !0, enumerable: !0 },
      Generators: { value: Fe, writable: !0, enumerable: !0 },
      html: { value: je(ze), writable: !0, enumerable: !0 },
      md: { value: He(t), writable: !0, enumerable: !0 },
      Mutable: { value: je(We), writable: !0, enumerable: !0 },
      now: { value: Ve, writable: !0, enumerable: !0 },
      Promises: { value: Ye, writable: !0, enumerable: !0 },
      require: { value: je(t), writable: !0, enumerable: !0 },
        ...
        value:
          ...
          function (e) {
            ...
            if (e instanceof Error && e.message)
              throw new it(e.message, r._name);
...
function _t(e, t = []) {
  Object.defineProperties(this, {
    ...
    _builtins: {
      value: new Map([['invalidation', gt], ['visibility', Et], ...t]),
    },
  ...
  define: {
    value: function (e, t, n) {
      ...
      return bt.call(
        this,
        null == e ? null : e + '',
        null == t ? [] : at.call(t, this._module._resolve, this._module),
    ...
    _resolve: {
      value: function (e) {
        var t,
          n = this._scope.get(e);
        if (!n)
          if (((n = new ft(2, this)), this._builtins.has(e)))
...
function jt(e) {
  ...
  var t = e._value,
    n = ++e._version,
    r = null,
    i = (e._promise = Promise.all(e._inputs.map(Pt))
      .then(function (i) {
        if (e._version === n) {
                  ...
                  var n = new Promise(function (e) {
                    ...
                    return r.done
                      ...
                      : Promise.resolve(r.value).then(function (r) {
                          if (e._version === t)
                            return Lt(e, r, n).then(i), e._fulfilled(r), r;
                        });
                  });
                  n.catch(function (r) {
      ...
      value: function () {
        ...
        do {
          ...
          e.forEach(function (t) {
            Ct(t) &&
              ($t(t, new it('circular definition')),
              t._outputs.forEach(St),
              e.delete(t));
          });
        } while (e.size);
        function r(e) {
